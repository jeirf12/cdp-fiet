package co.edu.unicauca.asae.cpdFiet.infraestructura.output.controladorExcepciones;
...
import co.edu.unicauca.asae.cpdFiet.infraestructura.output.controladorExcepciones.estructuraExcepciones.Error;
import co.edu.unicauca.asae.cpdFiet.infraestructura.output.controladorExcepciones.estructuraExcepciones.CodigoError;
import co.edu.unicauca.asae.cpdFiet.infraestructura.output.controladorExcepciones.estructuraExcepciones.ErrorUtils;
...
public class RestApiExceptionHandler {
        ...
        public ResponseEntity<Error> handleGenericException(HttpServletRequest req,
                        ReglaNegocioExcepcion ex, Locale locale) {
                Error error = ErrorUtils
